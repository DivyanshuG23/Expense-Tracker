    ...
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="min-h-[240px] flex-1">
        ...
        {data.length === 0 ? (
          ...
          <div className="flex h-full min-h-[240px] items-center justify-center rounded-xl border border-dashed border-[#D6B56D]/10 text-sm text-slate-500">
